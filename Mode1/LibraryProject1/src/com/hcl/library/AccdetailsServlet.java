...
/**
 * Servlet implementation class AccdetailsServlet
 */
public class AccdetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher disp1 = request.getRequestDispatcher("/UserAccount");
		...
		String result=new LibraryDAO().AccdetailsServlet(username);
